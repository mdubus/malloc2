...
UNIT_SRC_FILES = test.c test_get_padded_size.c test_create_new_link.c test_create_new_memory_block.c test_search_best_fit.c
...
SRC_DIR = src
SRC_FILES = malloc.c create_new_link.c get_padded_size.c create_new_memory_block.c search_best_fit.c
